...
class MyNet(nn.Module):
    def __init__(self, in_channel=1, channel1=32, channel2=64, num_classes=10):
        
        super(MyNet, self).__init__()
        
        self.conv1 = nn.Conv2d(in_channel, channel1, kernel_size=4, stride=2)
        #self.pool1 = nn.MaxPool2d(2)
        self.conv2 = nn.Conv2d(channel1, channel2, 5)   #过完这一层的图像大小为9*9
    ...
    def forward(self, x):
        ...
        scores = (F.relu(self.fc2(F.relu(self.fc1(temp2)))))
        return scores
